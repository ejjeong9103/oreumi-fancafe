DROP TABLE IF EXISTS `rank_up_board`;
...
DROP TABLE IF EXISTS `enjoy_board`;
...
DROP TABLE IF EXISTS `free_replay`;

CREATE TABLE `free_replay` (
                               `id`	bigint	NOT NULL,
                               `content`	text	NOT NULL,
                               `created_at`	timestamp	NOT NULL	DEFAULT now(),
                               `updated_at`	timestamp	NOT NULL	DEFAULT now(),
...
DROP TABLE IF EXISTS `enjoy_reply`;
...
ALTER TABLE `free_replay` ADD CONSTRAINT `PK_FREE_REPLAY` PRIMARY KEY (
                                                                       `id`
    );
...
ALTER TABLE `free_replay` ADD CONSTRAINT `FK_free_board_TO_free_replay_1` FOREIGN KEY (
                                                                                       `free_id`
    )
...
ALTER TABLE `free_replay` ADD CONSTRAINT `FK_user_TO_free_replay_1` FOREIGN KEY (
                                                                                 `user_id`
    )
    REFERENCES `user` (
                       `user_id`
